...
class ToFixItem(BaseItem):
    def __init__(self, heading, location):
        super(ToFixItem, self).__init__(heading)
    ...
    def construct(cls):
        input_function = get_input_function()
        heading = input_function('Input heading: ')
        location = input_function('Input location of error: ')
        return ToFixItem(heading, location)
